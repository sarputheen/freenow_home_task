...
public class MainActivityTest2 {
    ...
    public void mainActivityTest2() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.edt_username),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("crazydog335"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.edt_password),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("venture"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatAutoCompleteTextView2 = onView(
                allOf(withId(R.id.textSearch), withText("Samantha Reed"),
                        childAtPosition(
                                allOf(withId(R.id.searchContainer),
                                        childAtPosition(
                                                withClassName(is("android.support.design.widget.CoordinatorLayout")),
        ...
        ViewInteraction appCompatAutoCompleteTextView4 = onView(
                allOf(withId(R.id.textSearch), withText("Samantha Reed"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatAutoCompleteTextView4.perform(pressImeActionButton());
        ...
        ViewInteraction appCompatAutoCompleteTextView5 = onView(
                allOf(withId(R.id.textSearch), withText("Samantha Reed"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatAutoCompleteTextView5.perform(pressImeActionButton());
        ...
        ViewInteraction appCompatAutoCompleteTextView6 = onView(
                allOf(withId(R.id.textSearch), withText("Samantha Reed"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatAutoCompleteTextView6.perform(replaceText("Saman"));

        ViewInteraction appCompatAutoCompleteTextView7 = onView(
                allOf(withId(R.id.textSearch), withText("Saman"),
                        childAtPosition(
                                allOf(withId(R.id.searchContainer),
                                        childAtPosition(
                                                withClassName(is("android.support.design.widget.CoordinatorLayout")),
